...
(function () {
	...
	function g(e) {
		...
		$e[$] = $e[z] = $e[W] = {
			...
			toString: true,
			valueOf: true
		}, $e[q] = $e[K] = $e[J] = {constructor: true, toString: true}, $e[G] = {constructor: true}, function () {
		...
		var qe = Ae || function (n) {
			...
			c: "}}"
		}, Me = {i: "if(!B[typeof t])return E;" + Ge.i, b: false}, Ve = {
			"&": "&amp;",
			"<": "&lt;",
			">": "&gt;",
			'"': "&quot;",
	...
	var H = {leading: false, maxWait: 0, trailing: false}, U = {
		configurable: false,
		enumerable: false,
		value: null,
		writable: false
